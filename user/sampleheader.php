                ...
                <div class="header-bar">
                    ...
                    <nav class="main-navigation">
                        ...
                        <ul class="menu">
                            ...
                            <li class="menu-item"><a href="viewprofile.php"><?php echo $a ?> </a></li>
                            <li class="menu-item"><a href="addchild.php">Add Child </a></li>
                            <li class="menu-item"><a href="viewchild.php">My Child </a></li>
                            <li class="menu-item current-menu-item"><a href="displaychild.php"> Book</a></li>
                            <li class="menu-item"><a href="viewappointment.php">View Bookings</a></li>
                            <li class="menu-item"><a href="childreport.php">Reports</a></li>
