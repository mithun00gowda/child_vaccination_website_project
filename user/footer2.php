</main> <footer class="site-footer" data-bg-image="images/5570834.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="widget"  style="color: white">
                                <h3 class="widget-title"><strong>CONTACT INFO</strong></h3>
                                <p>Immunisation Drive Program, Head Office</p>
                                <address> Arogya Soudha, Bengaluru, Karnataka</address>
                                <a href="tel:+917823660788">+91 7823660788</a> <br>
                                <a href="mailto:support@immunise.gov.in">support@immunise.gov.in</a>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="widget"  style="color: white">
                                ...
                                <ul class="arrow-list">
                                    ...
                                    <li><a href="displayvaccine1.php" style="color:white">Book vaccination slot</a></li> 
